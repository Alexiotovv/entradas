...
//encriptando contraseña
	$pass=md5($password);
		...
		///finzalizo encriptacion
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono)
				VALUES('$usuario','$pass','$img','$tipo','$nombre','$apellido','$telefono')")or die(mysqli_error($con));
		...
		$pass=$salt.$pass;
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono)
				VALUES('$usuario','$pass','','$tipo','$nombre','$apellido','$telefono')")or die(mysqli_error($con));
