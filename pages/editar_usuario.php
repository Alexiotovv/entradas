...
?>
     ...
     <div class="row">
        ...
        <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo $row['apellido'];?>"   required>
            ...
            <input type="text" class="form-control" id="telefono"  name="telefono" onkeyup="Principal();" value="<?php echo $row['telefono'];?>" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
                ...
                <select class="form-control select2" style="width: 60%;" name="tipo" id="tipo"> <br>
                     <option value="bueno" <?php if($tipo=="administrador") {echo "selected"; }?>>administrador</option> 
                     <option value="regular" <?php if($tipo=="empleado") {echo "selected"; }?>>empleado</option> 
