...
<head>
    ...
    <title>entradas y salidas TUSOLUTIONWEB</title>
    <!-- meta tags -->
    <meta charset="UTF-8" />
...
<body>
    ...
    <form action="login.php" method="post">
        ...
        <p class=" w3l-register-p">Cotza tu desarrollo web por chat aqui?<a href="https://ventadecodigofuente.com/" class="register"> Cotiza aqui</a></p>
    </div>

    <CENTER>
      <footer>
          <div class="pull-right">
                             <a href="https://ventadecodigofuente.com/">sys gimnacio tusulutionweb Sys</a>
          </div>
